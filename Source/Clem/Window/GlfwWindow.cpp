...
void GlfwWindow::update(Time dt)
{
    ...
    // Silver
    standard->uploadUniform("u_material.ambient", Vector3::unit * 0.19225);
    standard->uploadUniform("u_material.diffuse", Vector3::unit * 0.50754);
    standard->uploadUniform("u_material.specular", Vector3::unit * 0.508273);
    standard->uploadUniform("u_material.shininess", 51.2f);
